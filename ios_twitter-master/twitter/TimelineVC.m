...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.tweetTimestamp.text = tweet.created_at;
    cell.username.text = tweet.prettyPrint;
    
    [cell.profileImage setImageWithURL:[NSURL URLWithString:tweet.profile_image_url]];
